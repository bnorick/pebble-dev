# Advanced Networking // Pebble Developers
...
* Callback: onHeaders(status, headers, statusText)
  * Description: Response headers received
* Callback: onReadable(count)
  * Description: Response body data available (count is the number of bytes available to read)
* Callback: onComplete()
