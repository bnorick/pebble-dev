# Pebble SDK 2.0 BETA4 - Changelog

Source: https://developer.repebble.com/sdk/changelogs/2.0-BETA4/

_Release Date: December 23 2013_
...
- Changed graphics\_text\_layout\_get\_max\_used\_size() to _not_ require a graphic context
...
- Ignore NULL pointer passed to text\_layer\_destroy()
...
- Fixed a bug where text\_layer could add ellipsis to the wrong line
...
- Fixed an exception when receiving APP\_LOG with extended characters
