...
Source: https://developer.repebble.com/sdk/changelogs/4.9.169/

_Release Date: May 1 2026_
...
- Added [`light_set_color`](/docs/c/User_Interface/Light/#light_set_color "light\_set\_color") / [`light_set_system_color`](/docs/c/User_Interface/Light/#light_set_system_color "light\_set\_system\_color") and the new `PBL_RGB_BACKLIGHT` define on Emery for full-tint backlight control; [`light_set_color_rgb888()`](/docs/c/User_Interface/Light/#light_set_color_rgb888 "light\_set\_color\_rgb888") is also available.
- Added [`rot_bitmap_layer_get_layer()`](/docs/c/User_Interface/Layers/RotBitmapLayer/#rot_bitmap_layer_get_layer "rot\_bitmap\_layer\_get\_layer") and the [`AppGlanceSliceLayout`](/docs/c/Foundation/App_Glance/#AppGlanceSliceLayout "AppGlanceSliceLayout")type to the public API.
- Updated Moddable (Alloy) to SDK 8.0.0, adding Pebble Touch support.
- Built `.pbw` files now have private metadata stripped.
- Fixed the aplite check in [`PBL_PLATFORM_SWITCH_DEFAULT`](/docs/c/Foundation/Platform/#PBL_PLATFORM_SWITCH_DEFAULT "PBL\_PLATFORM\_SWITCH\_DEFAULT").
