...
Source: https://developer.repebble.com/sdk/changelogs/3.9/

_Release Date: February 3 2016_
...
- Added the new [Health API](/guides/events-and-services/health.md)!
...
- Added [`PBL_IF_MICROPHONE_ELSE`](/docs/c/Foundation/Dictation/#PBL_IF_MICROPHONE_ELSE "PBL\_IF\_MICROPHONE\_ELSE"), `PBL_IF_SMARTSTRAP_ELSE`, and[`PBL_IF_HEALTH_ELSE`](/docs/c/Foundation/Event_Service/HealthService/#PBL_IF_HEALTH_ELSE "PBL\_IF\_HEALTH\_ELSE") macros, for consistency with [`PBL_IF_COLOR_ELSE`](/docs/c/Graphics/Graphics_Types/#PBL_IF_COLOR_ELSE "PBL\_IF\_COLOR\_ELSE") and friends. This also includes new `PBL_MICROPHONE`, `PBL_SMARTSTRAP`, and`PBL_HEALTH` defines.
