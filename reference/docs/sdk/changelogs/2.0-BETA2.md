# Pebble SDK 2.0 BETA2 - Changelog

Source: https://developer.repebble.com/sdk/changelogs/2.0-BETA2/

_Release Date: November 14 2013_
...
- Only log app\_log (and not system log) by default. Use `--verbose` to get all the logs.
