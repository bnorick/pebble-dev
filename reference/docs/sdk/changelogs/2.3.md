...
Source: https://developer.repebble.com/sdk/changelogs/2.3/

_Release Date: June 30 2014_
...
- Fixed a small memory leak when destroying number\_layer objects
- Fixed a menu\_layer display bug when header height is set to 0
