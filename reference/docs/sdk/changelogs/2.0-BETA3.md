# Pebble SDK 2.0 BETA3 - Changelog

Source: https://developer.repebble.com/sdk/changelogs/2.0-BETA3/

_Release Date: December 12 2013_
...
- do not crash if an app\_message section is re-opened - display warning instead
...
- Export dict\_size so external developers don't have to do pointer math :)
...
- menu\_cell\_basic\_draw() now automatically center the text in the cell. If you do not want a subtitle, pass NULL (otherwise, space will be reserved for the subtitle).
