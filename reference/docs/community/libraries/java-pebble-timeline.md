...
Source: https://developer.repebble.com/community/libraries/java-pebble-timeline/
...
```
\<dependency\>\<groupId\>nl.palolem\</groupId\>\<artifactId\>pebble-timeline\</artifactId\>\<version\>1.1\</version\>\</dependency\>
```
