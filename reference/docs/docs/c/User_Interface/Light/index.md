...
Source: https://developer.repebble.com/docs/c/User_Interface/Light/index.html
...
void light\_enable\_interaction(void)
...
void light\_enable(bool enable)
...
void light\_set\_color(GColor color)
...
GColor carries only 2 bits per channel (64 distinct tints). Use [light\_set\_color\_rgb888()](/docs/c/User_Interface/Light/#light_set_color_rgb888) if you need the full 8-bit-per-channel range that the LED hardware supports.
...
void light\_set\_color\_rgb888([uint32\_t](/docs/c/Standard_C/#uint32_t) rgb)
...
void light\_set\_system\_color(void)
