...
```
"resources": {"media": [{"type": "bitmap","name": "EXAMPLE\_IMAGE","file": "images/example-image.png"}]}
```
...
```
"resources": {"media": [{"type": "bitmap","name": "BACKGROUND\_IMAGE","file": "images/background.png","targetPlatforms": ["basalt"]}]}
```
