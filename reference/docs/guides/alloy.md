...
Source: https://developer.repebble.com/guides/alloy/
...
- [**Advanced Networking**](/guides/alloy/advanced-networking.md) - Low-level HTTP and WebSocket clients for advanced networking needs.

- [**Animations**](/guides/alloy/animations.md) - Create smooth animations using Timeline and easing functions.

- [**App Messages**](/guides/alloy/app-messages.md) - Send and receive messages between the watch and the phone.

- [**Getting Started with Alloy**](/guides/alloy/getting-started.md) - Learn how to create your first Alloy app for Pebble.

- [**Networking**](/guides/alloy/networking.md) - Make HTTP requests and use WebSockets via the phone proxy.

- [**Piu UI Framework**](/guides/alloy/piu-guide.md) - Build declarative user interfaces with the Piu framework.

- [**Poco Graphics**](/guides/alloy/poco-guide.md) - Low-level graphics rendering with the Poco framework.

- [**Port (Custom Drawing)**](/guides/alloy/port-drawing.md) - Combine Piu's declarative UI with custom drawing using Port.

- [**Sensors and Input**](/guides/alloy/sensors-and-input.md) - Access Pebble sensors and handle button input in Alloy apps.

- [**Storage**](/guides/alloy/storage.md) - Persist data between app launches using localStorage, key-value storage, or files.

- [**Watchfaces**](/guides/alloy/watchfaces.md) - Build custom watchfaces with Alloy.
...
| Example | Description |
| --- | --- |
| [hellomessage](https://github.com/Moddable-OpenSource/pebble-examples/tree/main/hellomessage) | Watch-phone messaging via app\_message |
